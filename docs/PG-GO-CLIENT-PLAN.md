...
| 包廂（`/room`；臨時隔間；**活著＝主持畫面開著**；主面＝包廂電視；門牌仍 `/i/`、TTL 只管請新人；開口為主、文字為輔；兩層螢幕；現況 Hub 轉送、mesh 延後） | 聊天室、房間、視訊會議格子牆、把局內 overlay 叫包廂；`/chat` 當 canonical；5 分鐘租期的雲端房間；再開 `/room` 當連上既有這一間；可行走大廳複製 |
