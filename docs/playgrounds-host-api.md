...
給撰寫／修改「現行 Agent」這類單頁小程式（SAM）的人（含 Agent 自己）快速對照。沙盒主軸仍是輕量 Web；Agent 用途可不限 coding。HOST 僅注入給現行 Agent。權威決策見 [DECISIONS.md](./DECISIONS.md) DEC-016／017／018／019／020／021／022／023／**024**／**029**／**030**／**031**／**032**／**035**／**036**；階段見 [PG-AGENT-PLAN.md](./PG-AGENT-PLAN.md)、[PG-SAM-RUNTIME-PLAN.md](./PG-SAM-RUNTIME-PLAN.md)、[PG-SECRETSTORE-PLAN.md](./PG-SECRETSTORE-PLAN.md)、[PG-SAM-ENV-SPEC.md](./PG-SAM-ENV-SPEC.md)、[PG-SAM-BINDINGS-SPEC.md](./PG-SAM-BINDINGS-SPEC.md)、[PG-MAIN-CONTENT-PLAN.md](./PG-MAIN-CONTENT-PLAN.md)、[PG-AGENT-MODEL-PLAN.md](./PG-AGENT-MODEL-PLAN.md)、[PG-AGENT-FLEET-UX-PLAN.md](./PG-AGENT-FLEET-UX-PLAN.md)。
