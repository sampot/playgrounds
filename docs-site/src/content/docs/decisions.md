---
title: 決策索引
description: 與場網／文件站相關的 Accepted 決策；全文在 repo。
---

架構決策以輕量 ADR 記在 [`docs/DECISIONS.md`](https://github.com/sampot/playgrounds/blob/main/docs/DECISIONS.md)。站上先列與宿主部署／文件最相關的幾筆：

| ID | 標題 | 要點 |
| --- | --- | --- |
| DEC-004 | 站台語系與品牌邊界 | 對外敘事非產品／行銷腔 |
